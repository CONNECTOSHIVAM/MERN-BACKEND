...
const registerUser = asyncHandler( async(req, res)=>{
    ...
    const coverPath = coverImageLocalPath ? path.resolve(coverImageLocalPath) : null;
    ...
    if(!createdUser){
        throw new ApiError(500, "Server error in registering user.")
    }
...
const logoutUser = asyncHandler( async(req,res)=>{
    ...
    ("refreshToken",options).json(new ApiResponse(200,{},"User logged out successfully."))
})
